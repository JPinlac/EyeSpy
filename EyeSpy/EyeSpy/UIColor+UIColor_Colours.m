...
@implementation UIColor (UIColor_Colours)

+ (UIColor *)salmonColor; {
    //    return [UIColor colorWithHueDegrees:210 saturation:1.0 brightness:1.0];
    return [UIColor colorWithRed:255/255.0f green:102/255.0f blue:102/255.0f alpha:0.9];
}

+ (UIColor *)floraColor {
    //    return UIColor(red:102/255, green:255/255, blue:102/255, alpha:1.0)
    return [UIColor colorWithRed:102/255.0f green:255/255.0f blue:102/255.0f alpha:0.9];
}
